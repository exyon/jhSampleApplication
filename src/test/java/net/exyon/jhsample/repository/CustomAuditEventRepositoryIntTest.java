package net.exyon.jhsample.repository;

import net.exyon.jhsample.JhSampleApplicationApp;
import net.exyon.jhsample.config.Constants;
import net.exyon.jhsample.config.audit.AuditEventConverter;
import net.exyon.jhsample.domain.PersistentAuditEvent;
...
import static net.exyon.jhsample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
