package net.exyon.jhsample.web.rest;

import net.exyon.jhsample.config.Constants;
import net.exyon.jhsample.JhSampleApplicationApp;
import net.exyon.jhsample.domain.Authority;
import net.exyon.jhsample.domain.PersistentToken;
import net.exyon.jhsample.domain.User;
import net.exyon.jhsample.repository.AuthorityRepository;
import net.exyon.jhsample.repository.PersistentTokenRepository;
import net.exyon.jhsample.repository.UserRepository;
import net.exyon.jhsample.security.AuthoritiesConstants;
import net.exyon.jhsample.service.MailService;
import net.exyon.jhsample.service.dto.UserDTO;
import net.exyon.jhsample.web.rest.errors.ExceptionTranslator;
import net.exyon.jhsample.web.rest.vm.KeyAndPasswordVM;
import net.exyon.jhsample.web.rest.vm.ManagedUserVM;
import net.exyon.jhsample.service.UserService;
...
@SpringBootTest(classes = JhSampleApplicationApp.class)
